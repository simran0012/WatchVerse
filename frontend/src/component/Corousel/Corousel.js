        ...
        <Carousel className="corousel">
            ...
            <Carousel.Item className="item">
                <img
                    ...
                    alt="First slide"
                />
                <a className="carousel-control-prev" role="button" tabindex="0" href="#"><span aria-hidden="true" className="carousel-control-prev-icon"></span><span className="visually-hidden">Previous</span></a>
                <a className="carousel-control-next" role="button" tabindex="0" href="#"><span aria-hidden="true" className="carousel-control-next-icon"></span><span className="visually-hidden">Next</span></a>
                <Carousel.Caption className="caption">
